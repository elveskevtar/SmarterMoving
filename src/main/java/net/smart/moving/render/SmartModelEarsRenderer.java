...
public class SmartModelEarsRenderer extends SmartModelSpecialRenderer {
	
	private int _i = 0;
	private EntityPlayer entityplayer;

	public SmartModelEarsRenderer(ModelBase modelBase, int i, int j, SmartModelRotationRenderer baseRenderer) {
