...
public class SmartModelCapeRenderer extends SmartModelSpecialRenderer {
	
	private final SmartModelRotationRenderer outer;
	private EntityPlayer entityplayer;
	private float setFactor;

	public SmartModelCapeRenderer(ModelBase modelBase, int i, int j,
			SmartModelRotationRenderer baseRenderer, SmartModelRotationRenderer outerRenderer) {
